            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  value: _selectedGender, // This will be null initially, displaying the hint text if no gender is selected
                  items: ['Male', 'Female', 'Other']
                    ...
                    child: Text(gender),
                      ...
                      .toList(),
                  decoration: InputDecoration(
                    labelText: 'Gender', // Label for the dropdown field
                  ),
                  hint: Text('Select Gender'), // Placeholder text when no value is selected
                  onChanged: (newValue) {
                    setState(() {
                      _selectedGender = newValue!;
                    });
                  },
                  validator: (value) => value == null ? 'Please select a gender' : null, // Optional validation
                ),
